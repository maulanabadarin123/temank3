  ...
  5274: function(e, t, r) {
      ...
      class X extends y.default.Component {
          ...
          componentDidMount() {
              ...
              j.isDynamicRoute)(n.pathname) || location.search || V) || a.props && a.props.__N_SSG && (location.search || V)) && n.replace(n.pathname + "?" + String((0,
              S.assign)((0,
      ...
      function Q(e) {
          ...
          i.loadPage("/_error").then(n=>{
              ...
              return (null == s ? void 0 : s.Component) === a ? Promise.resolve().then(()=>m._(r(3499))).then(n=>Promise.resolve().then(()=>m._(r(5035))).then(r=>(t = r.default,
              e.App = t,
              n))).then(e=>({
              ...
              E.loadGetInitialProps)(t, f)).then(t=>ei({
                  ...e,
                  err: l,
                  Component: u,
                  styleSheets: s,
  ...
  5932: function(e, t, r) {
      ...
      class V {
          ...
          async change(e, t, r, n, a) {
              ...
              let W = F || n._shouldResolveHref || (0,
              ...
              this._inFlightRoute && this.clc && (X || V.events.emit("routeChangeError", I(), this._inFlightRoute, J),
              this.clc(),
              this.clc = null),
              r = (0,
              w.addBasePath)((0,
              ...
              try {
                  ...
                  if (F || n.shallow || await this._bfl(r, "resolvedAs"in o ? o.resolvedAs : void 0, q.locale),
                  "route"in o && el) {
                      ea = et = o.route || ea,
                      J.shallow || (er = Object.assign({}, o.query || {}, er));
                      let e = (0,
                      j.hasBasePath)(ee.pathname) ? (0,
                  ...
                  if (!v) {
                      ...
                      if (o.error)
                          throw F || V.events.emit("routeChangeError", o.error, Q, J),
                          o.error;
          ...
          async getRouteInfo(e) {
              ...
              try {
                  ...
                  this.isPreview || !x.__N_SSG || p || W(Object.assign({}, O, {
                      isBackground: !0,
                      persistCache: !1,
          ...
          constructor(e, t, n, {initialProps: a, pageLoader: i, App: l, wrapApp: u, Component: s, err: c, subscription: f, isFallback: m, locale: g, locales: _, defaultLocale: b, domainLocales: v, isPreview: P}) {
              this.sdc = {},
              this.sbc = {},
